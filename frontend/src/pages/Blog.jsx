      ...
      <div className="max-w-screen-xl mx-auto p-5 sm:p-8 md:p-12 relative bg-#2A2A2A">
        <div
          ...
          style={{
            height: "450px",
            backgroundImage:
              "url('/Images/latest.jpg')", // Replace with a relevant image for Auto Part Bazar
          }}
        ></div>
          ...
          <div className="mt-3 bg-#1A1A1A rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
            <div className="">
              ...
              <h1 href="#" className="text-white font-bold text-3xl mb-2">
                Welcome to Auto Part Bazar: Revolutionizing Auto Part Shopping
              </h1>
              ...
              <p className="text-base leading-8 my-5 text-gray-400">
                Auto Part Bazar is your one-stop solution for high-quality auto parts. We provide everything from engine oils
                ...
                Whether you're a professional mechanic or a car enthusiast, Auto Part Bazar is here to meet all your needs.
              </p>

              <h3 className="text-2xl font-bold my-5 text-white">#1. The Vision Behind Auto Part Bazar</h3>

              <p className="text-base leading-8 my-5 text-gray-400">
                At Auto Part Bazar, our goal is to make the shopping experience for auto parts more accessible, transparent,
              ...
              <p className="text-base leading-8 my-5 text-gray-400">
                From the latest car parts to essential maintenance products, Auto Part Bazar has got you covered. Whether
              ...
              <h3 className="text-2xl font-bold my-5 text-white">#2. Why Choose Auto Part Bazar?</h3>

              <p className="text-base leading-8 my-5 text-gray-400">
                One of the major benefits of shopping with Auto Part Bazar is our commitment to providing top-notch customer service. 
              ...
              <p className="text-base leading-8 my-5 text-gray-400">
                Auto Part Bazar offers an extensive catalog of auto parts ranging from everyday essentials like filters and fluids 
              ...
              <h3 className="text-2xl font-bold my-5 text-white">#4. How Auto Part Bazar Is Changing the Industry</h3>

              <p className="text-base leading-8 my-5 text-gray-400">
                The automotive industry has traditionally been slow to adapt to digital transformation, but Auto Part Bazar is changing 
              ...
              <p className="text-base leading-8 my-5 text-gray-400">
                ...
                Auto Part Bazar and experience the next level of automotive shopping today.
              </p>
